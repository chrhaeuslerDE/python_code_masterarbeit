...
X_train = train[0:45000,6:26]
y_train = train[0:45000,27]
X_test = test[53:209,6:26] #Sequence 2
y_test = test[53:209,27]

X_test2 = test[8404:18584,6:26] #Sequence 63
y_test2 = test[8404:18584,27]
...
def dense():
    model = Sequential()
    model.add(Dense(23, input_dim=X_train.shape[1], kernel_initializer='normal', activation='tanh'))
...
print('Train...')
his = model.fit(X_train, y_train, batch_size=batch_size, epochs=250, verbose=1, 
